            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 flex lg:mb-[70px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">HIPAA, HITECH</p>
                </div>
              </div>
              <div className="mb-12 flex lg:mb-[70px]">
                <div className="mr-4 flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xl bg-primary text-white sm:mr-6 sm:h-[60px] sm:max-w-[60px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">SOC 2, PCI-DSS</p>
                </div>
              </div>
            </div>
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 flex lg:mb-[70px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">GDPR, CCPA</p>
                </div>
              </div>
              <div className="mb-12 flex lg:mb-[70px]">
                <div className="mr-4 flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xl bg-primary text-white sm:mr-6 sm:h-[60px] sm:max-w-[60px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">FedRAMP, NIST 800-53</p>
                </div>
              </div>
            </div>
          </div>
