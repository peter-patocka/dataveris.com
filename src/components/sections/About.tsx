const About = () => {
  return (
    <>
      <section className="bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]" id="about">
            ...
            <div className="flex flex-wrap px-4">
              <div className="mx-auto mb-[60px] max-w-[485px] text-center">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  Dataveris is a U.S.-based software development and compliance consulting firm
                  specializing in delivering secure, scalable, and regulation-ready digital
                  solutions. We combine deep technical expertise with a rigorous understanding of
                  global security standards—so your product not only performs, it passes audits.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white pb-10 pt-20 dark:bg-dark-2 lg:pb-20 lg:pt-[120px]" id="services">
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap justify-center">
              ...
              <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-12 wow fadeInUp group" data-wow-delay=".1s">
                  ...
                  <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                    Compliance-focused SaaS applications
                  </p>
                  <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                  ...
                  <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                    Full SDLC with audit-friendly documentation
                  </p>
                </div>
              </div>
              <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-12 wow fadeInUp group" data-wow-delay=".15s">
                  ...
                  <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                    HIPAA, SOC 2, PCI-DSS, ISO 27001 readiness
                  </p>
                  <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                    Cloud security architecture reviews
                  </p>
                  <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                    Internal training for developers and ops teams
                  </p>
                  <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
