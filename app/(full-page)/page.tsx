            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        <img src={`/layout/images/${layoutConfig.colorScheme === 'light' ? 'logo-dark' : 'logo-white'}.jpg`} alt="Sakai Logo" height="50" className="mr-0 lg:mr-2" />
                ...
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4">
                        ...
                        <Button type="button" label="Get a Free Consultation" rounded className="text-xl border-none mt-3 bg-blue-500 font-normal line-height-3 px-3 text-white"></Button>
                    </div>
                        ...
                        >
                            <div className="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
                                ...
                                <p className="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-4" style={{ maxWidth: '800px' }}>
                                    Dataveris is a U.S.-based software development and compliance consulting firm specializing in delivering secure, scalable, and regulation-ready digital solutions. We combine deep technical expertise with a rigorous
                                    understanding of global security standards—so your product not only performs, it passes audits.
                                </p>
                            </div>
                        </div>
                ...
                <div id="our-mission" className="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                    <div className="text-center">
                        <h2 className="text-900 font-normal mb-2">Our Mission</h2>
                    </div>
                    ...
                    <div className="grid mt-8 pb-2 md:pb-8">
                        ...
                        <div className="col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-right">
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal">To make compliance a driver of growth</h2>
                            <span className="text-700 text-2xl line-height-3 ml-0 md:ml-2" style={{ maxWidth: '650px' }}>
                                Not a blocker. We combine expertise in AI, software development, and regulatory frameworks to help businesses innovate with confidence.
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="grid my-8 pt-2 md:pt-8">
                        <div className="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
                            ...
                            <h2 className="line-height-1 text-900 text-4xl font-normal">Our Difference</h2>
                            <span className="text-700 text-2xl line-height-3 mr-0 md:mr-2" style={{ maxWidth: '650px' }}>
                                We don’t just advise. We build and deliver working AI tools that save time, reduce risk, and make audits painless.
                            </span>
                        </div>
                    ...
                    <div className="grid justify-content-between">
                        <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
                            <Link href="/" className="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer">
                                <img src={`/layout/images/${layoutConfig.colorScheme === 'light' ? 'logo-dark' : 'logo-white'}.jpg`} alt="footer sections" width="50" height="50" className="mr-2" />
                        ...
                        <div className="col-12 md:col-10 lg:col-7">
                            <div className="grid text-center md:text-left">
                                <div className="col-12 md:col-4">
                                    ...
                                    <a className="line-height-3 text-xl block cursor-pointer mb-2 text-700">5900 Balcones Drive #20540</a>
                                    <a className="line-height-3 text-xl block cursor-pointer mb-2 text-700">Austin, TX 78731</a>
                                </div>
                                ...
                                <div className="col-12 md:col-4 mt-4 md:mt-0">
                                    ...
                                    <a className="line-height-3 text-xl block cursor-pointer mb-2 text-700" href="tel:3466801990">
                                        (346) 680-1990
                                    </a>
                                </div>
                            </div>
